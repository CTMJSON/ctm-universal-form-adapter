...
| [FormAssembly]([https://help.formassembly.com/help/webhooks-connector][(https://help.formassembly.com/help/webhook-connector](https://help.formassembly.com/help/webhook-connector)) | `form_data` object with semantic field keys | Best article for posting submission data to an external endpoint. |
